...
@section('title', 'Ecozyne | Registrasi')
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="number" class="form-control" name="kode_pos" id="kode_pos" placeholder="Masukkan kode pos" required min="10000" max="99999">
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control" name="password" id="kataSandi" placeholder="Masukkan kata sandi" required minlength="6">
