                ...
                <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="card w-100">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-semibold mb-4">Data Riwayat Pesanan Produk</h5>
                            <hr>
                            <div class="mb-3">
                                ...
                                <table id="dataTable" class="table text-nowrap mb-0 align-middle">
                                    <thead class="text-dark fs-4">
                                        <tr>
                                          ...
                                          <th><h6 class="fw-semibold mb-0">Nama Barang</h6></th>
                                          <th><h6 class="fw-semibold mb-0">Jumlah Barang</h6></th>
                                          <th><h6 class="fw-semibold mb-0">Harga</h6></th>
                                          <th><h6 class="fw-semibold mb-0">Alamat Komunitas</h6></th>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>07 Mei 2025</td>
                                          <td><span class="badge bg-success" id="status-1">Selesai</span></td>
                                        </tr>
                                        <tr>
                                          <td>2</td>
                                          <td>sitinur</td>
