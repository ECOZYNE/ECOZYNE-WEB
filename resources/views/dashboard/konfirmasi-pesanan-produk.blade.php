...
@section('content')
  <div class="col-lg-12 d-flex align-items-stretch">
    ...
    <div class="card-body p-4">
      <h5 class="card-title fw-semibold mb-4">Data Konfirmasi Produk</h5>
      <hr>
      <div class="mb-3">
      ...
      <table id="dataTable" class="table text-nowrap mb-0 align-middle">
        ...
        <tr>
          ...
          <div class="dropdown">
            ...
            <li><a class="dropdown-item" href="javascript:void(0);"
              onclick="terimaPesanan('Andi Saputra')">Terima</a></li>
            <li><a class="dropdown-item" href="javascript:void(0);"
              onclick="tolakPesanan('Andi Saputra')">Tolak</a></li>
            </ul>
          </div>
          </td>
        </tr>
        <tr>
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="actionDropdown">
            <li><a class="dropdown-item" href="javascript:void(0);"
              onclick="terimaPesanan('Siti Nurhaliza')">Terima</a></li>
            <li><a class="dropdown-item" href="javascript:void(0);"
              onclick="tolakPesanan('Siti Nurhaliza')">Tolak</a></li>
            </ul>
          </div>
          </td>
        </tr>
