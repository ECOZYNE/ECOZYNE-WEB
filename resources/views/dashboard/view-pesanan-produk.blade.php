            ...
            <div class="card-body p-4">
                ...
                <div class="timeline-container d-none d-lg-block">
                    <div class="timeline-nav" id="timelineNav">
                        <div class="timeline-item active" data-status="diterima">
                            ...
                            <div class="timeline-label">
                                Diterima
                                <div class="status-badge status-diterima">Produk sedang disiapkan</div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item" data-status="dikemas">
                            ...
                            <div class="timeline-label">
                                Dikemas
                                <div class="status-badge status-dikemas">Produk sedang dikemas</div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item" data-status="selesai">
                            ...
                            <div class="timeline-label">
                                Selesai
                                <div class="status-badge status-selesai">Pesanan selesai</div>
                            </div>
                        </div>
                    </div>
                </div>
