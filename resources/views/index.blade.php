            ...
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100">Eco Enzyme adalah solusi alami untuk menjaga kebersihan dan
                        kelestarian lingkungan. Dengan mengolah sampah organik menjadi cairan serbaguna, kita bisa
                        mengurangi
                    ...
                    <div class="d-flex flex-column flex-md-row" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <!-- Video Kedua -->
                        <a href="assets2/vid/eco_enzyme2.mp4" class="glightbox d-none" data-gallery="video-gallery"
                            data-type="video" data-poster="assets2/img/thumb2.png">
                        </a>
                    </div>
                </div>
            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-8 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                    <div class="content">
                        ...
                        <h2>Ecozyne merupakan platform berbasis web yang berfokus pada edukasi dan promosi pemanfaatan Eco
                            Enzyme
                            secara berkelanjutan.</h2>
                        <p>
                            Sistem ini dikembangkan untuk meningkatkan kesadaran masyarakat tentang pentingnya pengelolaan
                            limbah
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
                    <div class="card">
                        ...
                        <p>Kami berkomitmen untuk memberikan pengetahuan yang mudah diakses tentang Eco Enzyme dan
                            pengelolaan
                ...
                <div class="col-lg-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="card">
                        ...
                        <p>Dengan mengolah sampah organik menjadi Eco Enzyme, kami membantu menciptakan lingkungan yang
                            lebih
                ...
                <div class="col-lg-3" data-aos="fade-up" data-aos-delay="300">
                    <div class="card">
                        ...
                        <p>Kami percaya bahwa perubahan besar dimulai dari kerja sama. Bersama komunitas, kita bisa
                            membangun
                ...
                <div class="col-lg-3" data-aos="fade-up" data-aos-delay="400">
                    <div class="card">
                        ...
                        <p>Kami tidak hanya menyebarkan informasi, tetapi juga mendorong tindakan nyata yang berdampak
                            positif
            ...
            <div class="row gy-4">
                    ...
                    <div class="stats-item d-flex align-items-center w-100 h-100">
                        ...
                        <div>
                            <span class="purecounter" data-purecounter-start="0"
                                data-purecounter-end="{{ $jumlahKomunitas }}" data-purecounter-duration="1"></span>
                            <p>Anggota</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="stats-item d-flex align-items-center w-100 h-100">
                        ...
                        <div>
                            <span class="purecounter" data-purecounter-start="0"
                                data-purecounter-end="{{ $jumlahBanksampah }}" data-purecounter-duration="1"></span>
                            <p>Bank Sampah</p>
                        </div>
                    </div>
                </div><!-- End Stats Item -->
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="stats-item d-flex align-items-center w-100 h-100">
                        ...
                        <div>
                            <span class="purecounter" data-purecounter-start="0"
                                data-purecounter-end="{{ $jumlahArtikel }}" data-purecounter-duration="1"></span>
                            <p>Artikel</p>
                        </div>
                    </div>
                </div><!-- End Stats Item -->
                    ...
                    <div class="row align-self-center gy-5">
                        <div class="col-md-6 icon-box">
                            ...
                            <div>
                                ...
                                <p>Setiap produk dan layanan kami dirancang dengan kualitas terbaik untuk menjawab kebutuhan
                                    Anda.</p>
                            </div>
                        ...
                        <div class="col-md-6 icon-box">
                            ...
                            <div>
                                ...
                                <p>Mengelola data dan operasional dengan sistem yang terintegrasi demi efisiensi maksimal.
                                </p>
                            </div>
                        </div><!-- End Feature Item -->
                        ...
                        <div class="col-md-6 icon-box">
                            ...
                            <div>
                                ...
                                <p>Temukan dan beli produk-produk Eco Enzyme berkualitas dari komunitas dan bank sampah
                                    lokal.</p>
                            </div>
                        </div><!-- End Feature Item -->
                        ...
                        <div class="col-md-6 icon-box">
                            ...
                            <div>
                                ...
                                <p>Dapatkan poin dari penyaluran sampah dan tukarkan dengan berbagai hadiah menarik secara
                                    langsung.
                                </p>
                            </div>
                        </div><!-- End Feature Item -->
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ 100 * $loop->iteration }}">
                        <div class="card catalog-item shadow-sm h-100 d-flex flex-column">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                @auth
                                    @php
                                        $komunitas = \App\Models\Komunitas::where(
                                            'id_user',
                                            Auth::user()->id_user,
                                        )->first();
                                        $sudahDaftar = $komunitas
                                            ? \App\Models\PendaftaranKegiatan::where(
                                                'id_komunitas',
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalLabel{{ $kegiatan->id_kegiatan }}">Detail Kegiatan
                                        </h5>
                                    ...
                                    <div class="modal-body">
                                        <img src="{{ asset('storage/kegiatan/' . $kegiatan->foto) }}"
                                            class="card-img-top catalog-img mb-4" alt="{{ $kegiatan->judul }}">
                        ...
                        <div class="card shadow-sm h-100 hover-lift">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mt-1 mb-2">
                                    <span class="badge badge-custom-green me-2"><i class="bi bi-truck"></i> Pengiriman 1-4
                                        Hari</span>
                                ...
                                @else
                                    <a href="{{ route('login') }}" class="btn btn-primary w-100 disabled" tabindex="-1"
                    ...
                    <div class="faq-container">
                        ...
                        <div class="faq-item faq-active">
                            ...
                            <div class="faq-content">
                                <p>Eco Enzyme adalah cairan hasil fermentasi limbah organik seperti kulit buah, gula, dan
                                    air yang
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>Campurkan 3 bagian air, 1 bagian gula (gula merah/gula molase), dan 10 bagian limbah
                                    organik
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>Eco Enzyme dapat digunakan sebagai pembersih rumah, pupuk tanaman, pengusir hama alami,
                                    hingga
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="faq-container">
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p> Aplikasi ini dapat digunakan oleh siapa saja, baik individu, komunitas, maupun bank
                                    sampah yang
                                    ingin belajar dan berkontribusi dalam gerakan Eco Enzyme,
                                    khususnya bagi warga Batam yang ingin turut serta menjaga lingkungan melalui pengelolaan
                                    limbah
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>Anda bisa mendaftar akun di halaman registrasi, lalu mulai mengikuti panduan dan
                                    berkontribusi
                                    bersama kami.</p>
                            </div>
                            <i class="faq-toggle bi bi-chevron-right"></i>
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>Ya, pengguna dapat menyalurkan sampah ke bank sampah terdaftar dan mendapatkan poin yang
                                    bisa
                    ...
                    @forelse ($galeri as $item)
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('storage/galeri/' . $item->foto) }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>{{ \Carbon\Carbon::parse($item->created_at)->format('d M Y : H.i') }}</h4>
                                    <p>{{ $item->deskripsi }}</p>
                                    <a href="{{ asset('storage/galeri/' . $item->foto) }}"
                                        title="{{ $item->deskripsi }}" data-gallery="portfolio-gallery-app"
