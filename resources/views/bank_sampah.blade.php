...
<head>
  ...
  <title>Ecozyne | Bank Sampah</title>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Roboto&family=Poppins&family=Nunito&display=swap"
    rel="stylesheet">
  ...
  <style>
    ...
    .transition-hover:hover {
      ...
      box-shadow: 0 1rem 1.5rem rgba(0, 128, 0, 0.2);
    }
  ...
  <main class="main mb-6">
    ...
    <div class="container">
      ...
      <div class="row g-4" id="bankSampahList">
        ...
        <div class="col-md-6 col-lg-3" data-kecamatan="sekupang" data-kelurahan="tiban_baru" data-nama="bank sampah sejahtera">
        ...
        <div class="col-md-6 col-lg-3" data-kecamatan="lubukbaja" data-kelurahan="baloi_indah" data-nama="bank sampah perumahan">
        ...
        <div class="col-md-6 col-lg-3" data-kecamatan="bengkong" data-kelurahan="bengkong_indah" data-nama="bank sampah berseri">
        ...
        <div class="col-md-6 col-lg-3" data-kecamatan="batamkota" data-kelurahan="sungai_panas" data-nama="bank sampah mandiri">
        ...
        <div class="col-md-6 col-lg-3" data-kecamatan="sagulung" data-kelurahan="sagulung_kota" data-nama="bank sampah bersih">
