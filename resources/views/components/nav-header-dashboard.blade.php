        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
            <div class="message-body">
              ...
              {{-- Menu Profil Saya (bisa untuk semua role) --}}
              <a href="{{ $role === 'admin' ? url('admin/my-profile') : url('dashboard/my-profile') }}" class="d-flex align-items-center gap-2 dropdown-item">
